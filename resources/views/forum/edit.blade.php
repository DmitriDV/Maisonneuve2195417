            ...
            <div class="row">
                <div class="col-xl-9 col-lg-10 mx-auto">
                    <div class="bg-faded rounded p-5">
                        ...
                        <h2 class="display-one mb-4">@lang('lang.title_forum_modify')</h2>
                        <form method="post">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="english" role="tabpanel" aria-labelledby="home-tab">
                                        <div class="control-group col-12">  
                                            ...
                                            <div class="cta-inner bg-faded text-center rounded">
                                                <input type="text" id="titre_en" class="form-control" name="titre_en" value="{{ $article->titre_en }}" >
                                            </div>
                                        ...
                                        <div class="control-group col-12 mt-2">
                                            ...
                                            <div class="cta-inner bg-faded text-center rounded">
                                                <textarea id="contenu_en" class="form-control" name="contenu_en" rows="" >{{ $article->contenu_en }}
                                                </textarea>
                                            </div>
                                    ...
                                    <div class="tab-pane fade" id="french" role="tabpanel" aria-labelledby="profile-tab">
                                        <div class="control-group col-12">
                                            ...
                                            <div class="cta-inner bg-faded text-center rounded">
                                                <input type="text" id="titre_fr" class="form-control" name="titre_fr" value="{{ $article->titre_fr }}" >
                                            </div>
                                        ...
                                        <div class="control-group col-12 mt-2">
                                            ...
                                            <div class="cta-inner bg-faded text-center rounded">
                                                <textarea id="contenu_fr" class="form-control" name="contenu_fr" rows="" >{{ $article->contenu_fr }}
                                                </textarea>
                                            </div>
                            ...
                            <button class="btn btn-outline-dark mt-4 mb-5" id="submitButton" type="submit">@lang('lang.button_forum_modify')</button>
