                                ...
                                <div class="card-header">
                                    <div class="media flex-wrap w-100 align-items-center"> <img src="https://dummyimage.com/50x50/dee2e6/6c7574.jpg" class="d-block ui-w-40 rounded-circle" alt="">
                                        <div class="media-body ml-3">
                                            <a href="{{ route('liste.show', $article->articleHasUser->id) }}" data-abc="true">{{$article->articleHasUser->nom}}</a>
                                        </div>
                                    ...
                                    <div class="text-muted small ml-3">
                                        <h4 class="">{{ $selectedArticle->titre }}</h4>
                                    </div>
                                    <div class="text-muted small ml-3">
                                        <div>@lang('lang.text_article_categorie')<strong>{{$categorie->categorie}}</strong></div>
                                    </div>
                                </div>
